		...
		<el-row>
			...
			<el-col type="flex" justify="center">
					...
					<el-col :span='12' class="login-left">
						<div class="left-box">
							<el-image style="width:60%;margin-bottom: 1rem;" :src="require('./Img/ccbpm.png')"></el-image>
							<div style="line-height: 2rem ;font-size: 1.5rem ;font-weight: 550 ;">
								<el-row>流程引擎二开工具包</el-row>
							</div>
							<ul>
								<li>资源:<a href="https://gitee.com/opencc/JFlow/wikis/pages/preview?sort_id=8095272&doc_id=31094" target="_blank" style="color:rgb(49, 104, 207)" >Toolkit在线文档</a> 
									- <a href="http://ccflow.org?frm=client" target="_blank" style="color:rgb(49, 104, 207)"> ccbpm官网</a></li>
					...
					<el-col :span='12' class="login-right">
						<el-form :model="ruleForm2" :rules="rules2" status-icon ref="ruleForm2" label-position="left"
							...
							<!-- <el-divider content-position="center" class="bottom_divider" hidden="hidden">其他登录</el-divider>
