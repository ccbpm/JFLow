...
MySQL - 5.7.24-log : Database - ccflow1
*********************************************************************
*/
...
/*Data for the table `gpm_appsort` */
...
/*Data for the table `gpm_empmenu` */
...
/*Data for the table `gpm_groupemp` */
...
/*Data for the table `gpm_groupmenu` */
...
/*Data for the table `gpm_groupstation` */
...
/*Data for the table `gpm_persetting` */
...
/*Data for the table `gpm_stationmenu` */
...
insert  into `port_dept`(`No`,`Name`,`NameOfPath`,`ParentNo`,`Idx`,`OrgNo`) values ('100','集团总部',NULL,'0',0,''),('1001','集团市场部',NULL,'100',0,''),('1002','集团研发部',NULL,'100',0,''),('1003','集团服务部',NULL,'100',0,''),('1004','集团财务部',NULL,'100',0,''),('1005','集团人力资源部',NULL,'100',0,''),('1060','南方分公司',NULL,'100',0,''),('1061','市场部',NULL,'1060',0,''),('1062','财务部',NULL,'1060',0,''),('1063','销售部',NULL,'1060',0,''),('1070','北方分公司',NULL,'100',0,''),('1071','市场部',NULL,'1070',0,''),('1072','财务部',NULL,'1070',0,''),('1073','销售部',NULL,'1070',0,''),('1099','外来单位',NULL,'100',0,'');
...
/*Data for the table `port_deptstation` */

insert  into `port_deptstation`(`FK_Dept`,`FK_Station`) values ('100','01'),('1001','07'),('1002','08'),('1003','09'),('1004','10'),('1005','11');

/*Table structure for table `port_emp` */
...
/*Data for the table `port_emp` */

insert  into `port_emp`(`No`,`Name`,`Pass`,`FK_Dept`,`SID`,`Tel`,`Email`,`PinYin`,`SignType`,`Idx`) values ('admin','admin','123','100','67ddcb6d-9210-4b20-bfcf-572d8c703005','0531-82374939','zhoupeng@ccflow.org',',admin,admin,',0,0),('fuhui','福惠','123','1003','','0531-82374939','fuhui@ccflow.org',',fuhui,fh,fh/jtfwb,',0,0),('guobaogeng','郭宝庚','123','1004','','0531-82374939','guobaogeng@ccflow.org',',guobaogeng,gbg,gbg/jtcwb,',0,0),('guoxiangbin','郭祥斌','123','1003','','0531-82374939','guoxiangbin@ccflow.org',',guoxiangbin,gxb,gxb/jtfwb,',0,0),('liping','李萍','123','1005','','0531-82374939','liping@ccflow.org',',liping,lp,lp/jtrlzyb,',0,0),('liyan','李言','123','1005','','0531-82374939','liyan@ccflow.org',',liyan,ly,ly/jtrlzyb,',0,0),('qifenglin','祁凤林','123','1002','','0531-82374939','qifenglin@ccflow.org',',qifenglin,qfl,qfl/jtyfb,',0,0),('yangyilei','杨依雷','123','1004','','0531-82374939','yangyilei@ccflow.org',',yangyilei,yyl,yyl/jtcwb,',0,0),('zhanghaicheng','张海成','123','1001','','0531-82374939','zhanghaicheng@ccflow.org',',zhanghaicheng,zhc,zhc/jtscb,',0,0),('zhangyifan','张一帆','123','1001','','0531-82374939','zhangyifan@ccflow.org',',zhangyifan,zyf,zyf/jtscb,',0,0),('zhoupeng','周朋','123','100','','0531-82374939','zhoupeng@ccflow.org',',zhoupeng,zp,zp/jtzb,',0,0),('zhoushengyu','周升雨','123','1001','','0531-82374939','zhoushengyu@ccflow.org',',zhoushengyu,zsy,zsy/jtscb,',0,0),('zhoutianjiao','周天娇','123','1002','','0531-82374939','zhoutianjiao@ccflow.org',',zhoutianjiao,ztj,ztj/jtyfb,',0,0);

/*Table structure for table `port_station` */
...
/*Data for the table `port_station` */

insert  into `port_station`(`No`,`Name`,`FK_StationType`,`OrgNo`) values ('01','总经理','1','0'),('02','市场部经理','2','0'),('03','研发部经理','2','0'),('04','客服部经理','2','0'),('05','财务部经理','2','0'),('06','人力资源部经理','2','0'),('07','销售人员岗','3','0'),('08','程序员岗','3','0'),('09','技术服务岗','3','0'),('10','出纳岗','3','0'),('11','人力资源助理岗','3','0'),('12','外来人员岗','3','0');
...
insert  into `port_stationtype`(`No`,`Name`,`Idx`,`OrgNo`) values ('1','高层',0,NULL),('2','中层',0,NULL),('3','基层',0,NULL);
...
/*Data for the table `sys_docfile` */
...
/*Data for the table `sys_encfg` */

insert  into `sys_encfg`(`No`,`GroupTitle`,`Url`,`FJSavePath`,`FJWebPath`,`Datan`,`UI`,`AtPara`) values ('BP.Sys.FrmUI.FrmAttachmentExt','@MyPK=基础信息,附件的基本配置.\n@DeleteWay=权限控制,控制附件的下载与上传权限.@IsRowLock=WebOffice属性,设置与公文有关系的属性配置.\n@IsToHeLiuHZ=流程相关,控制节点附件的分合流.',NULL,NULL,NULL,NULL,NULL,NULL),('BP.WF.CCBill.FrmBill','@No=基础信息,单据基础配置信息.@BtnNewLable=单据按钮权限,用于控制每个功能按钮启用规则.@BtnImpExcel=列表按钮,列表按钮控制@Designer=设计者,流程开发设计者信息',NULL,NULL,NULL,NULL,NULL,NULL),('BP.WF.Template.FlowExt','@No=基本配置',NULL,NULL,NULL,NULL,NULL,NULL),('BP.WF.Template.FlowSheet','@No=基本配置@FlowRunWay=启动方式,配置工作流程如何自动发起，该选项要与流程服务一起工作才有效.@StartLimitRole=启动限制规则@StartGuideWay=发起前置导航@DTSWay=流程数据与业务数据同步@PStarter=轨迹查看权限',NULL,NULL,NULL,NULL,NULL,NULL),('BP.WF.Template.FrmNodeComponent','@NodeID=审核组件,适用于sdk表单审核组件与ccform上的审核组件属性设置.@SFLab=父子流程组件,在该节点上配置与显示父子流程.@FrmThreadLab=子线程组件,对合流节点有效，用于配置与现实子线程运行的情况。@FrmTrackLab=轨迹组件,用于显示流程运行的轨迹图.@FTCLab=流转自定义,在每个节点上自己控制节点的处理人.',NULL,NULL,NULL,NULL,NULL,NULL),('BP.WF.Template.MapDataExt','@No=基本属性@Designer=设计者信息',NULL,NULL,NULL,NULL,NULL,NULL),('BP.WF.Template.MapDtlExt','@No=基础信息,基础信息权限信息.@IsExp=数据导入导出,数据导入导出.@MTR=多表头,实现多表头.@IsEnableLink=超链接,显示在从表的右边.@IsCopyNDData=流程相关,与流程相关的配置非流程可以忽略.',NULL,NULL,NULL,NULL,NULL,NULL),('BP.WF.Template.MapFrmFool','@No=基础属性,基础属性.@Designer=设计者信息,设计者的单位信息，人员信息，可以上传到表单云.',NULL,NULL,NULL,NULL,NULL,NULL),('BP.WF.Template.NodeExt','@NodeID=基本配置@FWCSta=审核组件,适用于sdk表单审核组件与ccform上的审核组件属性设置.@SendLab=按钮权限,控制工作节点可操作按钮.@RunModel=运行模式,分合流,父子流程@AutoJumpRole0=跳转,自动跳转规则当遇到该节点时如何让其自动的执行下一步.@MPhone_WorkModel=移动,与手机平板电脑相关的应用设置.@TSpanDay=考核,时效考核,质量考核.',NULL,NULL,NULL,NULL,NULL,NULL),('BP.WF.Template.NodeSheet','@NodeID=基本配置@FormType=表单@FWCSta=审核组件,适用于sdk表单审核组件与ccform上的审核组件属性设置.@SFSta=父子流程,对启动，查看父子流程的控件设置.@SendLab=按钮权限,控制工作节点可操作按钮.@RunModel=运行模式,分合流,父子流程@AutoJumpRole0=跳转,自动跳转规则当遇到该节点时如何让其自动的执行下一步.@MPhone_WorkModel=移动,与手机平板电脑相关的应用设置.@TSpanDay=考核,时效考核,质量考核.@OfficeOpen=公文按钮,只有当该节点是公文流程时候有效',NULL,NULL,NULL,NULL,NULL,NULL);
...
/*Data for the table `sys_enummain` */
...
/*Data for the table `sys_enverdtl` */
...
/*Data for the table `sys_excelfield` */
...
/*Data for the table `sys_excelfile` */
...
/*Data for the table `sys_excelsheet` */
...
/*Data for the table `sys_exceltable` */
...
/*Data for the table `sys_filemanager` */
...
/*Data for the table `sys_formtree` */

insert  into `sys_formtree`(`No`,`Name`,`ParentNo`,`OrgNo`,`Idx`,`IsDir`) values ('1','表单库','0','',0,0);
...
CREATE TABLE `sys_frmattachment` (
  ...
  `Name` varchar(50) DEFAULT NULL COMMENT '名称',
  `Exts` varchar(50) DEFAULT NULL COMMENT '要求上传的格式',
  ...
  `W` float DEFAULT NULL COMMENT 'TBWidth',
  `H` float DEFAULT NULL COMMENT 'H',
  `IsUpload` int(11) DEFAULT '1' COMMENT '是否可以上传',
  `DeleteWay` int(11) DEFAULT '0' COMMENT '附件删除规则(0=不能删除1=删除所有2=只能删除自己上传的',
  ...
  `IsExpCol` int(11) DEFAULT '0' COMMENT '是否启用扩展列',
  `IsShowTitle` int(11) DEFAULT '1' COMMENT '是否显示标题列',
  `UploadType` int(11) DEFAULT '0' COMMENT '上传类型0单个1多个2指定',
  `CtrlWay` int(11) DEFAULT '0' COMMENT '控制呈现控制方式0=PK,1=FID,2=ParentID',
  `AthUploadWay` int(11) DEFAULT '0' COMMENT '控制上传控制方式0=继承模式,1=协作模式.',
  `ReadRole` int(11) DEFAULT '0' COMMENT '阅读规则',
  `DataRefNoOfObj` varchar(150) DEFAULT NULL COMMENT '数据引用组件ID',
  ...
  `IsWoEnableTemplete` int(11) DEFAULT '0' COMMENT '是否启用模板文件',
  `IsWoEnableCheck` int(11) DEFAULT '1' COMMENT '是否记录节点信息',
  `IsWoEnableInsertFlow` int(11) DEFAULT '1' COMMENT '是否启用插入流程',
  `IsWoEnableInsertFengXian` int(11) DEFAULT '1' COMMENT '是否启用插入风险点',
  `IsWoEnableMarks` int(11) DEFAULT '1' COMMENT '是否进入留痕模式',
...
/*Data for the table `sys_frmattachment` */
...
/*Data for the table `sys_frmattachmentdb` */
...
CREATE TABLE `sys_frmbtn` (
  ...
  `GroupIDText` varchar(200) DEFAULT '0' COMMENT '所在分组',
  PRIMARY KEY (`MyPK`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='按钮';

/*Data for the table `sys_frmbtn` */
...
/*Data for the table `sys_frmeledb` */
...
/*Data for the table `sys_frmevent` */
...
/*Data for the table `sys_frmimgath` */
...
/*Data for the table `sys_frmimgathdb` */
...
/*Data for the table `sys_frmline` */
...
/*Data for the table `sys_frmlink` */
...
/*Data for the table `sys_frmreportfield` */
...
/*Data for the table `sys_glovar` */

insert  into `sys_glovar`(`No`,`Name`,`Val`,`GroupKey`,`Note`,`Idx`) values ('0','选择系统约定默认值',NULL,'DefVal',NULL,0),('@CurrWorker','当前工作可处理人员',NULL,'DefVal',NULL,0),('@FK_ND','当前年度',NULL,'DefVal',NULL,0),('@FK_YF','当前月份',NULL,'DefVal',NULL,0),('@WebUser.FK_Dept','登陆人员部门编号',NULL,'DefVal',NULL,0),('@WebUser.FK_DeptFullName','登陆人员部门全称',NULL,'DefVal',NULL,0),('@WebUser.FK_DeptName','登陆人员部门名称',NULL,'DefVal',NULL,0),('@WebUser.Name','登陆人员名称',NULL,'DefVal',NULL,0),('@WebUser.No','登陆人员账号',NULL,'DefVal',NULL,0),('@yyyy年mm月dd日','当前日期(yyyy年MM月dd日)',NULL,'DefVal',NULL,0),('@yyyy年mm月dd日HH时mm分','当前日期(yyyy年MM月dd日HH时mm分)',NULL,'DefVal',NULL,0),('@yy年mm月dd日','当前日期(yy年MM月dd日)',NULL,'DefVal',NULL,0),('@yy年mm月dd日HH时mm分','当前日期(yy年MM月dd日HH时mm分)',NULL,'DefVal',NULL,0);
...
/*Data for the table `sys_groupenstemplate` */
...
/*Data for the table `sys_groupfield` */

/*Table structure for table `sys_langue` */
...
CREATE TABLE `sys_mapattr` (
  ...
  PRIMARY KEY (`MyPK`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Boolen字段';

/*Data for the table `sys_mapattr` */
...
CREATE TABLE `sys_mapdata` (
  ...
  PRIMARY KEY (`No`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='单据属性';

/*Data for the table `sys_mapdata` */
...
CREATE TABLE `sys_mapframe` (
  ...
  `FrmID` varchar(50) DEFAULT '0' COMMENT '表单表单',
  `FrmIDText` varchar(200) DEFAULT '0' COMMENT '表单表单',
  `Idx` int(11) DEFAULT '0' COMMENT '顺序号',
  PRIMARY KEY (`MyPK`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='框架';

/*Data for the table `sys_mapframe` */
...
/*Data for the table `sys_rptdept` */
...
/*Data for the table `sys_rptstation` */
...
/*Data for the table `sys_rpttemplate` */
...
/*Data for the table `sys_serial` */

insert  into `sys_serial`(`CfgKey`,`IntVal`) values ('BP.WF.Template.FlowSort',102),('UpdataCCFlowVer',417141633);
...
/*Data for the table `sys_sfdbsrc` */

insert  into `sys_sfdbsrc`(`No`,`Name`,`DBSrcType`,`UserID`,`Password`,`IP`,`DBName`) values ('local','本机数据源(默认)',0,'','','','');
...
/*Data for the table `sys_sftable` */
...
/*Data for the table `sys_userlogt` */

insert  into `sys_userlogt`(`MyPK`,`FK_Emp`,`IP`,`LogFlag`,`Docs`,`RDT`) values ('2d7e64899c2c4d0895d1b43ca6b64f6f','admin','127.0.0.1','SignIn','登录','2019-04-18 09:46'),('8ac92aca686b43cdbba8cd5b111e660b','admin','127.0.0.1','SignIn','登录','2019-04-18 09:46'),('ac81bc77ddc0474baf405d25742313c3','admin','127.0.0.1','SignIn','登录','2019-04-18 09:46'),('fe58b1418949448c872a8b78c98796da','admin','127.0.0.1','SignIn','登录','2019-04-18 09:46');
...
/*Data for the table `sys_userregedit` */
...
/*Data for the table `sys_wfsealdata` */
...
/*Data for the table `wf_accepterrole` */

/*Table structure for table `wf_athunreadlog` */
...
/*Data for the table `wf_athunreadlog` */
...
/*Data for the table `wf_billtemplate` */

/*Table structure for table `wf_ccbill` */
...
/*Data for the table `wf_ccstation` */

/*Table structure for table `wf_cctrack` */
...
/*Data for the table `wf_deptflowsearch` */
...
/*Data for the table `wf_direction` */
...
/*Data for the table `wf_directionstation` */
...
CREATE TABLE `wf_emp` (
  ...
  `Idx` int(11) DEFAULT '0' COMMENT 'Idx',
  PRIMARY KEY (`No`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='子公司人员';

/*Data for the table `wf_emp` */
...
/*Data for the table `wf_findworkerrole` */
...
CREATE TABLE `wf_flow` (
  ...
  PRIMARY KEY (`No`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='报表定义';

/*Data for the table `wf_flow` */
...
/*Data for the table `wf_flowformtree` */
...
/*Data for the table `wf_flowsort` */

insert  into `wf_flowsort`(`No`,`ParentNo`,`Name`,`OrgNo`,`Domain`,`Idx`) values ('1','0','流程树','0','',0),('100','1','日常办公类','0','',0),('101','1','财务类','0','',0),('102','1','人力资源类','0','',0);

/*Table structure for table `wf_frmmethod` */
...
CREATE TABLE `wf_frmmethod` (
  ...
  `MethodDoc_Url` text COMMENT '连接URL',
  `MethodDocTypeOfFunc` int(11) DEFAULT '0' COMMENT '内容类型',
  PRIMARY KEY (`MyPK`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='功能方法';

/*Data for the table `wf_frmmethod` */
...
CREATE TABLE `wf_frmnode` (
  ...
  `FrmSln` int(11) DEFAULT '0' COMMENT '控制方案',
  `IsEnableFWC` int(11) DEFAULT '0' COMMENT '是否启用审核组件？',
  `Idx` int(11) DEFAULT '0' COMMENT '顺序号',
  `Is1ToN` int(11) DEFAULT '0' COMMENT '是否1变N？(分流节点有效)',
  `HuiZong` varchar(300) DEFAULT '' COMMENT '汇总的数据表名',
  `TempleteFile` varchar(500) DEFAULT '' COMMENT '模版文件',
  `GuanJianZiDuan` varchar(20) DEFAULT '' COMMENT '关键字段',
  `FrmEnableRole` int(11) DEFAULT '0' COMMENT '启用规则',
  `FrmEnableExp` text COMMENT '启用的表达式',
...
/*Data for the table `wf_generworkerlist` */
...
CREATE TABLE `wf_generworkflow` (
  ...
  PRIMARY KEY (`WorkID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='流程查询';

/*Data for the table `wf_generworkflow` */
...
CREATE TABLE `wf_node` (
  ...
  `SFActiveFlows` varchar(100) DEFAULT '' COMMENT '启动的子流程',
  ...
  `GroupStaNDs` varchar(500) DEFAULT '' COMMENT '岗位分组节点',
  `X` int(11) DEFAULT '0' COMMENT 'X坐标',
  `Y` int(11) DEFAULT '0' COMMENT 'Y坐标',
  ...
  PRIMARY KEY (`NodeID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='审核组件';
...
/*Data for the table `wf_nodecancel` */
...
/*Data for the table `wf_nodedept` */
...
/*Data for the table `wf_nodereturn` */
...
/*Data for the table `wf_nodestation` */
...
/*Data for the table `wf_nodesubflow` */
...
/*Data for the table `wf_nodetoolbar` */

/*Table structure for table `wf_part` */
...
/*Data for the table `wf_rememberme` */
...
/*Data for the table `wf_returnwork` */
...
/*Data for the table `wf_selectaccper` */
...
/*Data for the table `wf_shiftwork` */
...
/*Data for the table `wf_sqltemplate` */
...
/*Data for the table `wf_testcase` */
...
/*Data for the table `wf_testsample` */
...
/*Data for the table `wf_testver` */

/*Table structure for table `wf_track` */
...
/*Data for the table `wf_transfercustom` */
...
/*Data for the table `wf_workflowdeletelog` */

/*Table structure for table `port_inc` */

DROP TABLE IF EXISTS `port_inc`;

/*!50001 DROP VIEW IF EXISTS `port_inc` */;
/*!50001 DROP TABLE IF EXISTS `port_inc` */;

/*!50001 CREATE TABLE  `port_inc`(
 `No` varchar(50) NOT NULL ,
 `Name` varchar(100) NULL ,
 `NameOfPath` varchar(300) NULL ,
 `ParentNo` varchar(100) NULL ,
 `Idx` int(11) NULL  default '0' ,
 `OrgNo` varchar(50) NULL  default '' 
)*/;

/*Table structure for table `v_flowstarter` */

DROP TABLE IF EXISTS `v_flowstarter`;

/*!50001 DROP VIEW IF EXISTS `v_flowstarter` */;
/*!50001 DROP TABLE IF EXISTS `v_flowstarter` */;

/*!50001 CREATE TABLE  `v_flowstarter`(
 `FK_Flow` varchar(150) NULL ,
 `FlowName` varchar(200) NULL ,
 `FK_Emp` varchar(150) NULL 
)*/;

/*Table structure for table `v_flowstarterbpm` */

DROP TABLE IF EXISTS `v_flowstarterbpm`;

/*!50001 DROP VIEW IF EXISTS `v_flowstarterbpm` */;
/*!50001 DROP TABLE IF EXISTS `v_flowstarterbpm` */;

/*!50001 CREATE TABLE  `v_flowstarterbpm`(
 `FK_Flow` varchar(150) NULL ,
 `FlowName` varchar(200) NULL ,
 `FK_Emp` varchar(150) NULL 
)*/;

/*Table structure for table `v_totalch` */

DROP TABLE IF EXISTS `v_totalch`;

/*!50001 DROP VIEW IF EXISTS `v_totalch` */;
/*!50001 DROP TABLE IF EXISTS `v_totalch` */;

/*!50001 CREATE TABLE  `v_totalch`(
 `FK_Emp` varchar(100) NULL ,
 `AllNum` bigint(21) NULL ,
 `ASNum` bigint(21) NULL ,
 `CSNum` bigint(21) NULL ,
 `JiShi` bigint(21) NULL ,
 `ANQI` bigint(21) NULL ,
 `YuQi` bigint(21) NULL ,
 `ChaoQi` bigint(21) NULL ,
 `WCRate` decimal(16,2) NULL 
)*/;

/*Table structure for table `v_totalchweek` */

DROP TABLE IF EXISTS `v_totalchweek`;

/*!50001 DROP VIEW IF EXISTS `v_totalchweek` */;
/*!50001 DROP TABLE IF EXISTS `v_totalchweek` */;

/*!50001 CREATE TABLE  `v_totalchweek`(
 `FK_Emp` varchar(100) NULL ,
 `WeekNum` int(11) NULL  default '0' ,
 `FK_NY` varchar(100) NULL ,
 `AllNum` bigint(21) NULL ,
 `ASNum` bigint(21) NULL ,
 `CSNum` bigint(21) NULL ,
 `JiShi` bigint(21) NULL ,
...
/*Table structure for table `v_totalchyf` */

DROP TABLE IF EXISTS `v_totalchyf`;

/*!50001 DROP VIEW IF EXISTS `v_totalchyf` */;
/*!50001 DROP TABLE IF EXISTS `v_totalchyf` */;

/*!50001 CREATE TABLE  `v_totalchyf`(
 `FK_Emp` varchar(100) NULL ,
 `FK_NY` varchar(100) NULL ,
 `AllNum` bigint(21) NULL ,
 `ASNum` bigint(21) NULL ,
...
/*Table structure for table `v_wf_delay` */

DROP TABLE IF EXISTS `v_wf_delay`;

/*!50001 DROP VIEW IF EXISTS `v_wf_delay` */;
/*!50001 DROP TABLE IF EXISTS `v_wf_delay` */;

/*!50001 CREATE TABLE  `v_wf_delay`(
 `MyPK` varchar(74) NULL ,
 `PRI` int(11) NULL ,
 `WorkID` int(11) NOT NULL  default '0' ,
 `IsRead` int(11) NULL ,
 `Starter` varchar(200) NULL ,
 `StarterName` varchar(200) NULL ,
 `WFState` bigint(20) NULL ,
 `FK_Dept` varchar(100) NULL ,
 `DeptName` varchar(100) NULL ,
 `FK_Flow` varchar(100) NULL ,
 `FlowName` varchar(100) NULL ,
 `PWorkID` int(11) NULL ,
 `PFlowNo` varchar(3) NULL ,
 `FK_Node` int(11) NULL ,
 `NodeName` varchar(500) NULL ,
 `WorkerDept` varchar(100) NULL ,
 `Title` text NULL ,
 `RDT` varchar(50) NULL ,
 `ADT` varchar(50) NULL ,
 `SDT` varchar(50) NULL ,
 `FK_Emp` varchar(50) NULL ,
 `FID` int(11) NULL ,
 `FK_FlowSort` varchar(100) NULL ,
 `SysType` varchar(10) NULL ,
 `SDTOfNode` varchar(50) NULL ,
 `PressTimes` bigint(20) NULL ,
 `GuestNo` varchar(100) NULL ,
 `GuestName` varchar(100) NULL ,
 `BillNo` varchar(100) NULL ,
 `FlowNote` mediumtext NULL ,
 `TodoEmps` mediumtext NULL ,
 `TodoEmpsNum` int(11) NULL ,
 `TodoSta` bigint(20) NULL ,
 `TaskSta` bigint(20) NULL ,
 `ListType` bigint(20) NOT NULL  default '0' ,
 `Sender` varchar(200) NULL ,
 `AtPara` text NULL ,
 `MyNum` bigint(20) NOT NULL  default '0' 
)*/;

/*Table structure for table `wf_empworks` */

DROP TABLE IF EXISTS `wf_empworks`;

/*!50001 DROP VIEW IF EXISTS `wf_empworks` */;
/*!50001 DROP TABLE IF EXISTS `wf_empworks` */;

/*!50001 CREATE TABLE  `wf_empworks`(
 `PRI` int(11) NULL ,
 `WorkID` int(11) NOT NULL  default '0' ,
 `IsRead` int(11) NULL ,
 `Starter` varchar(200) NULL ,
...
/*View structure for view port_inc */
...
/*View structure for view v_flowstarter */
...
/*View structure for view v_flowstarterbpm */
...
/*View structure for view v_totalch */
...
/*View structure for view v_totalchweek */
...
/*View structure for view v_totalchyf */
...
/*View structure for view v_wf_delay */
...
/*View structure for view wf_empworks */
