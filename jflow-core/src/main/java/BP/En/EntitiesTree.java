...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	...
	public final String ToJsonOfTree()
	{
		return ToJsonOfTree("0");
	}

//C# TO JAVA CONVERTER NOTE: Java does not support optional parameters. Overloaded method(s) are created above:
//ORIGINAL LINE: public string ToJsonOfTree(string rootNo="0")
	public final String ToJsonOfTree(String rootNo)
	{
		appendMenus = new StringBuilder();
		appendMenuSb = new StringBuilder();
		BP.En.Entity tempVar = this.GetEntityByKey(EntityTreeAttr.ParentNo, rootNo);
	...
	public final void AddChildren(EntityTree parentEn, EntitiesTree ens)
	{
		appendMenus.append(appendMenuSb);
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	...
	{
		BP.En.Entities tempVar = this.CreateInstance();
	...
	/** 
	 根据位置取得数据
	*/
	public final EntityTree get(int index)
	{
