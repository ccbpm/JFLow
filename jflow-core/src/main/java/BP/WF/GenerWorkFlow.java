...
public class GenerWorkFlow extends Entity {
	...
	public Map getEnMap() {
		...
		map.AddTBString(GenerWorkFlowAttr.DoDomain, null, "域/系统编号", true, false, 0, 100, 30);
		map.SetHelperAlert(GenerWorkFlowAttr.DoDomain, "用于区分不同系统的流程,比如:一个集团有多个子系统每个子系统都有自己的流程,就需要标记那些流程是那个子系统的.");
