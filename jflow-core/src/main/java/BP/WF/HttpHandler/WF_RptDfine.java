				...
				case DDL:
					...
					switch (ar.getLGType())
					{
						...
						case FK:
							...
							else
							{
								...
								else
								{
									...
									{
										dtNoName.Rows.Add(en.GetValStringByKey(ar.getHisAttr().getUIRefKeyValue()), en.GetValStringByKey(ar.getHisAttr().getUIRefKeyText()));
									}
						...
						case Enum:
							...
							{
								dtNoName.Rows.Add(en.getIntKey(), en.getLab());
							}
