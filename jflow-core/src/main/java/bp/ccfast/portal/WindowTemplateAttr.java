...
public class WindowTemplateAttr extends EntityNoNameAttr
{
	...
	*/
	...
	public static final String DefaultChart = "DefaultChart";

	public static final String C1Ens = "C1Ens";
	public static final String C2Ens = "C2Ens";
	public static final String C3Ens = "C3Ens";
