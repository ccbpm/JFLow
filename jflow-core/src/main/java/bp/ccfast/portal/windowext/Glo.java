...
public class Glo
{
	public static Map StationDBSrcMap(String desc)
	{
		...
		map.AddTBStringDoc(WindowTemplateAttr.C1Ens, null, "列1外键数据(可选)", true, false, true, 10);
		map.AddTBStringDoc(WindowTemplateAttr.C2Ens, null, "列2外键数据(可选)", true, false, true, 10);
		map.AddTBStringDoc(WindowTemplateAttr.C3Ens, null, "列3外键数据(可选)", true, false, true, 10);
