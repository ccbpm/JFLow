...
//			emp.setPass(DBAccess.GenerGUID());
//			emp.Insert();
//		}
//
...
//			org.setWXUseSta(1);
//			org.setDTReg(DataType.CurrentDateTime);
...
//
//			///#region 开始同步部门信息.
//		bp.cloud.port.Dept deptRoot = new Dept();
...
//		bp.cloud.port.Org org = new Org(orgNo);
//		org.setWXUseSta(0);
//		org.setDTEnd(DataType.CurrentDateTime);
//		org.Update();
//	}
	/** 
	 当人员信息变化时
