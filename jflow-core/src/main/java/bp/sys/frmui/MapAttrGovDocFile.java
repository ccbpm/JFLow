...
/** 
 公文正文组件
*/
public class MapAttrGovDocFile extends EntityMyPK
{
	...
	*/
	...
	/** 
	 实体属性
	*/
	public MapAttrGovDocFile(String mypk)throws Exception
	{
	...
	*/
	...
	protected boolean beforeUpdateInsertAction() throws Exception {
		...
		this.SetValByKey(MapAttrAttr.UIContralType, UIContralType.GovDocFile.getValue());
