...
public class MapAttrString extends EntityMyPK {
	...
	public Map getEnMap() throws Exception {
		...
		// map.AddDDLSysEnum(MapAttrAttr.UIContralType, 0, "控件", true, false,
		// MapAttrAttr.UIContralType);
		...
		// CCS样式
		// map.AddDDLSQL(MapAttrAttr.CSS, "0", "控件样式", MapAttrString.SQLOfCSSAttr,
		// true);
	...
	protected void afterDelete() throws Exception {
		...
		if (DBAccess.IsExitsTableCol("Sys_FrmImg", "KeyOfEn") == true) {
			sql = "DELETE FROM Sys_FrmImg WHERE FK_MapData='" + this.getFK_MapData() + "' AND KeyOfEn='"
					+ this.getKeyOfEn() + "T'";
		}
		DBAccess.RunSQL(sql);
		...
		if (this.getFK_MapData().contains("ND") == true) {
			...
			sql = "DELETE FROM Sys_MapAttr WHERE FK_MapData='" + fk_mapData + "' AND( KeyOfEn='" + this.getKeyOfEn()
					+ "T' OR KeyOfEn='" + this.getKeyOfEn() + "')";
			DBAccess.RunSQL(sql);
		}
	...
	public final String DoRenameField(String newField) throws Exception {
		...
		if (this.getFK_MapData().indexOf("ND") == 0) {
			...
			for (MapData item : mds.ToJavaList()) {
				sql = "UPDATE Sys_MapAttr SET KeyOfEn='" + newField + "',  MyPK='" + item.getNo() + "_" + newField
						+ "' WHERE KeyOfEn='" + this.getKeyOfEn() + "' AND FK_MapData='" + item.getNo() + "'";
				DBAccess.RunSQL(sql);
			}
		} else {
			sql = "UPDATE Sys_MapAttr SET KeyOfEn='" + newField + "', MyPK='" + this.getFK_MapData() + "_" + newField
					+ "'  WHERE KeyOfEn='" + this.getKeyOfEn() + "' AND FK_MapData='" + this.getFK_MapData() + "'";
			DBAccess.RunSQL(sql);
		}
	...
	public final String DoFastEnter() throws Exception {
		return "../../Admin/FoolFormDesigner/MapExt/FastInput.htm?FK_MapData=" + this.getFK_MapData() + "&KeyOfEn="
				+ this.getKeyOfEn();
	}
	...
	public final String DoPop2019() throws Exception {
		return "../../Admin/FoolFormDesigner/Pop/Default.htm?FK_MapData=" + this.getFK_MapData() + "&KeyOfEn="
				+ this.getKeyOfEn();
	}
	...
	public final String DoGeneralField() throws Exception {
		return "../../Admin/FoolFormDesigner/General/GeneralField.htm?FrmID=" + this.getFK_MapData() + "&KeyOfEn="
				+ this.getKeyOfEn();
	}
	...
	public final String DoDefVal() throws Exception {
		return "../../Admin/FoolFormDesigner/DefVal.htm?FK_MapData=" + this.getFK_MapData() + "&KeyOfEn="
				+ this.getKeyOfEn();
	}
	...
	public final String DoSetFlowBBS() throws Exception {
		...
		mapAttrs.Retrieve(MapAttrAttr.FK_MapData, this.getFK_MapData(), MapAttrAttr.UIContralType,
				getUIContralType().FlowBBS.getValue());
		if (mapAttrs.size() == 0) {
	...
	public final String DoEleBatch() throws Exception {
		// return "../../Admin/FoolFormDesigner/EleBatch.aspx?EleType=MapAttr&KeyOfEn="
		// + this.KeyOfEn + "&FType=1&MyPK=" + this.MyPK + "&FK_MapData=" +
		// this.FK_MapData;
	...
	public final String DoFastInput() throws Exception {
		return "../../Admin/FoolFormDesigner/MapExt/MultipleInputSearch.htm?FK_MapData=" + this.getFK_MapData()
				+ "&KeyOfEn=" + this.getKeyOfEn() + "&m=s";
	...
	public final String DoPopVal() throws Exception {
		return "../../Admin/FoolFormDesigner/MapExt/PopVal.htm?FK_MapData=" + this.getFK_MapData() + "&KeyOfEn="
				+ this.getKeyOfEn() + "&MyPK=" + this.getMyPK() + "&FK_MapExt=PopVal_" + this.getFK_MapData() + "_"
				+ this.getKeyOfEn();
	}
	...
	public final String DoInputCheck() throws Exception {
		return "../../Admin/FoolFormDesigner/MapExt/InputCheck.htm?FK_MapData=" + this.getFK_MapData() + "&OperAttrKey="
				+ this.getKeyOfEn() + "&RefNo=" + this.getMyPK() + "&DoType=New&ExtType=InputCheck";
	}
	...
	public final String DoEditFExtContral() throws Exception {
		return "../../Admin/FoolFormDesigner/EditFExtContral.htm?FK_MapData=" + this.getFK_MapData() + "&KeyOfEn="
	...
	public final String DoEditFExtContral2019() throws Exception {
		return "../../Admin/FoolFormDesigner/EditFExtContral/Default.htm?FK_MapData=" + this.getFK_MapData()
				+ "&KeyOfEn=" + this.getKeyOfEn() + "&MyPK=" + this.getMyPK();
	}
			...
			if (md.RetrieveFromDBSources() == 1) {
				if (DBAccess.IsExitsTableCol(md.getPTable(), this.getKeyOfEn()) == true) {
					...
					if (SystemConfig.getAppCenterDBType() == DBType.PostgreSQL) {
						sql = "ALTER table " + md.getPTable() + " alter " + attr.getField() + " type character varying("
								+ attr.getMaxLen() + ")";
					}
