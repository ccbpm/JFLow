...
public class Node extends Entity
{
	...
	*/
	...
	{
		Works obj = this.getHisWork().getGetNewEntities() instanceof Works ? (Works)this.getHisWork().getGetNewEntities() : null;
		return obj;
	}
	/** 
	 流程
	...
	*/
	...
	protected boolean beforeDelete() throws Exception
	{
		...
		//判断是否可以被删除. 
		num = DBAccess.RunSQLReturnValInt("SELECT COUNT(*) FROM WF_GenerWorkerlist WHERE IsPass=1 and FK_Node=" + this.getNodeID());
		if (num != 0)
		{
