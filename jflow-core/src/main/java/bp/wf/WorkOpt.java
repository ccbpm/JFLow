...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	public final void setSendNote(String value)
	{
	...
	public final void setSendEmps(String value)
	{
	...
	public final void setSendDepts(String value)
	{
	...
	public final void setSendStas(String value)
	{
	...
	public final void setCCEmps(String value)
	{
	...
	public final void setCCDepts(String value)
	{
	...
	public final void setCCStations(String value)
	{
	...
	public final void setCCNote(String value)
	{
	...
	public final void setSendRDT(String value)
	{
	...
	public final void setStartRDT(String value)
	{
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	public Map getEnMap()
	{
		...
		protected boolean beforeUpdateInsertAction() throws Exception {
			if (bp.da.DataType.IsNullOrEmpty(this.getStartRDT()) == true)
			{
				this.setStarterName(bp.web.WebUser.getFK_DeptName() + "\\" + bp.web.WebUser.getName());
				this.setStartRDT(bp.da.DataType.getCurrentDateTime());
			}
		...
		/**
		 ...
		 @return
		 */
		public final DataTable GenerCCers()
		{
			...
			{
				sql = "SELECT " + bp.sys.base.Glo.getUserNo() + ",Name FROM Port_Emp A, Port_DeptEmpStation B  WHERE A." + bp.sys.base.Glo.getUserNoWhitOutAS() + "= B.FK_Emp AND B.FK_Station IN(" + bp.port.Glo.GenerWhereInSQL(this.getCCStations()) + ")";
				mydt = DBAccess.RunSQLReturnTable(sql);
				for (DataRow mydr : mydt.Rows)
				{
					dr = dt.NewRow();
