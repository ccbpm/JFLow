...
/** 
 流程实例
*/
public class GenerWorkFlowExt extends Entity
{
	...
	*/
	...
	/**
	 ...
	 param workId
	*/
	public GenerWorkFlowExt(long workId) throws Exception {
	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.AddDDLEntities(GenerWorkFlowViewAttr.FK_Dept, null, "隶属部门", new Depts(), false);
	...
	//        rm.IsForEns = true;
		...
		rm.getHisAttrs().AddTBString("Note", null, "催办信息", true, false, 0, 500, 200);
		rm.IsForEns = false;
		map.AddRefMethod(rm);
	...
	*/
	...
	public String DoPress(String msg)
	{
		try
		{
			String doPressMsg= Dev2Interface.Flow_DoPress(this.getWorkID(), msg, true);
			return doPressMsg;
		}
		catch (Exception ex)
		{
	...
	public String DoFlowOver(String note) throws Exception {
		Dev2Interface.Flow_DoFlowOver(this.getWorkID(), note,0);
