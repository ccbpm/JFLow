...
public class GenerWorkFlowView extends Entity
{
	...
	*/
	...
	public final String DoTest(String toEmpNo, String toNodeID) throws NumberFormatException, Exception
	{
		return bp.wf.Dev2Interface.Flow_ReSend(this.getWorkID(), Integer.parseInt(toNodeID), toEmpNo, WebUser.getName() + ":调整.");
	}
	...
	*/
	public final String DoRollback(String nodeID, String note)throws Exception
	{
		try
		{
			return bp.wf.Dev2Interface.Flow_DoRebackWorkFlow(this.getFK_Flow(), this.getWorkID(), Integer.parseInt(nodeID), note);
		}
		catch (RuntimeException ex)
		{
