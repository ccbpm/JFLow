...
public class WF_RptDfine extends WebContralBase
{
	...
	*/
	...
	public final String FlowSearch_Done() throws Exception
	{
		...
		{
			qo.DoQuery("OID", DataType.IsNullOrEmpty(pageSize) ? SystemConfig.getPageSize() : Integer.parseInt(pageSize), pageIdx, ur.getOrderBy(), ur.getOrderWay());
		}
		else
		{
	...
	*/
	public final String FlowSearch_Exp() throws Exception
	{
		...
		String filePath = ExportDGToExcel(qo.DoQueryToTable(), ges.getGetNewEntity(), title, attrsa);
