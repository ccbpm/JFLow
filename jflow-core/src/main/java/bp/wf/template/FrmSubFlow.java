...
public class FrmSubFlow extends Entity
{
	...
	*/
	...
	/** 
	 Y
	*/
	public final float getSfY() throws Exception
	{
		return this.GetValFloatByKey(FrmSubFlowAttr.SF_Y);
	}
	public final void setSfY(float value) throws Exception
	{
	...
	/** 
	 X
	*/
	public final float getSfX() throws Exception
	{
		return this.GetValFloatByKey(FrmSubFlowAttr.SF_X);
	}
	public final void setSfX(float value) throws Exception
	{
	...
	*/
	...
	/** 
	 W
	*/
	public final float getSfW() throws Exception
	{
		return this.GetValFloatByKey(FrmSubFlowAttr.SF_W);
	}
	public final void setSfW(float value) throws Exception
	{
		this.SetValByKey(FrmSubFlowAttr.SF_W, value);
	}
	public final String getSFWstr() throws Exception
	{
		if (this.getSfW() == 0)
		{
			return "100%";
		}
		return this.getSfW() + "px";
	}
	/** 
	 H
	*/
	...
	public final String getSFHstr() throws Exception
	{
		if (this.getSfH() == 0)
		{
			return "100%";
		}
		return this.getSfH() + "px";
	}
	/** 
	 轨迹图是否显示?
	*/
