...
public class MapDtlExt extends EntityNoName
{
	...
	*/
	public final String OpenAthAttr() throws Exception
	{
		...
		// string url = "../../Admin/FoolFormDesigner/DtlSetting/DtlImp.htm?FK_MapData=" + this.getNo()+ "&FromDtl=1&IsFirst=1&UserNo=" + WebUser.getNo() + "&SID=" + WebUser.getSID() + "&AppCenterDBType=" + DBAccess.getAppCenterDBType() + "&CustomerNo=" + SystemConfig.getCustomerNo();
		return url;
	}
	...
	*/
	public final String DoMultiTitle()throws Exception
	{
		...
		//return "../../Admin/FoolFormDesigner/DtlSetting/MultiTitle.htm?DtlID=" + this.getNo()+ "&t=" + DataType.getCurrentDataTime();
	}
	/** 
	 设计自由表单
