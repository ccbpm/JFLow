...
public class NodeWorkCheck extends Entity
{
	...
	*/
	...
	/** 
	 Y
	*/
	public final float getFwcY()throws Exception
	{
		return this.GetValFloatByKey(NodeWorkCheckAttr.FWC_Y);
	}
	public final void setFwcY(float value) throws Exception
	{
	...
	/** 
	 X
	*/
	public final float getFwcX()throws Exception
	{
		return this.GetValFloatByKey(NodeWorkCheckAttr.FWC_X);
	}
	public final void setFwcX(float value) throws Exception
	{
	...
	*/
	...
	public final void setFwcW(float value) throws Exception
	{
		this.SetValByKey(NodeWorkCheckAttr.FWC_W, value);
	}
	public final String getFWCWstr()throws Exception
	{
		if (this.getFwcW() == 0)
		{
			return "100%";
		}
		return this.getFwcW() + "px";
	}
	/** 
	 H
	*/
	...
	*/
	...
	public final int getFWCMsgShow()throws Exception{
	...
	*/
	...
	public Map getEnMap() throws Exception
	{
		...
		map.AddDDLSysEnum(NodeWorkCheckAttr.FWCAth, getFWCAth().None.getValue(), "附件上传", true, true, NodeWorkCheckAttr.FWCAth, "@0=不启用@1=多附件@2=单附件(暂不支持)@3=图片附件(暂不支持)");
		...
		map.AddTBString(NodeWorkCheckAttr.FWCDefInfo, "", "默认审核信息", true, false, 0, 100, 10);
	...
	protected void afterInsertUpdateAction() throws Exception
	{
		...
		if (this.getFWCLab().equals("审核组件") == false)
		{
			...
			groupFields.Retrieve(GroupFieldAttr.FrmID, "ND" + this.getNodeID(), GroupFieldAttr.CtrlType, GroupCtrlType.FWC);
