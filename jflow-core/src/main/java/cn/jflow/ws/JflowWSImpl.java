...
@Deprecated
@WebService(endpointInterface="cn.jflow.ws.JflowWS",serviceName="JflowWS")
public class JflowWSImpl implements JflowWS {
	...
	private DataSet GenerWorkNode(String fk_flow, int fk_node, long workID,
		...
		try {
			...
			DataSet myds =CCFormAPI.GenerHisDataSet(md.getNo(),null);
	...
	private DataSet GenerWorkNodeV2(String fk_flow, int fk_node, long workID,
		...
		try {
			...
			DataSet ds=CCFormAPI.GenerHisDataSet(md.getNo(),null);	
