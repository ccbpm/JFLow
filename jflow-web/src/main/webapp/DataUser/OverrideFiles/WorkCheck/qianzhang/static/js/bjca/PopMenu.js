...
function ESeaL_CreateSignMenu($_$CurStampID) {
	...
	sigMenuDiv.setAttribute("style", "/*! display: none; */  top: 86px; position: fixed;margin: 0 0 0 30px;");
	...
	ulObj.setAttribute("style", "list-style: none;width: 60px;background: rgba(10,75,68,0.9);padding: 14px;color: #fff; border-radius: 8px;");
