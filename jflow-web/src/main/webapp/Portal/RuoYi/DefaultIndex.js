    ...
    window.vm = new Vue({
        ...
        methods: {
            ...
            GoToAppClassic: function () {
                ...
                SetHref("../AppClassic/Login.htm?UserNo=" + webUser.No + "&Token=" + webUser.Token + "&OrgNo=" + webUser.OrgNo);
            },
            GoToMobile: function () {
                var webUser = new WebUser();  //退出
                var url = "../../FastMobilePortal/Login.htm?UserNo=" + webUser.No + "&Token=" + webUser.Token + "&OrgNo=" + webUser.OrgNo;
                SetHref(url);
            },
            initMenus: function () {
