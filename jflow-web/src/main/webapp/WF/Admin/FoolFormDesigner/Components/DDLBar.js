...
function ExtIDCard() {
    ...
    if (frmType != 8)
        window.location.href = "../../../Comm/EnOnly.htm?EnName=BP.Sys.FrmUI.MapAttrCard&MyPK=" + frmID + "_IDCardNo";
    if (frmType == 8) {
...
function MapAttrFixed() {
    ...
    if (frmType != 8)
        window.location.href = "../../../Comm/EnOnly.htm?EnName=BP.Sys.FrmUI.MapAttrFixed&MyPK=" + mapAttr.MyPK;
    if (frmType == 8) {
