<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import = "cn.jflow.common.model.DeptTreeModel" %>
<%@ include file="/WF/head/head1.jsp"%>
<!DOCTYPE HTML>
<html>
<head>
<%
	DeptTreeModel dt = new DeptTreeModel(request,response);
	String nodeId = dt.getFK_Node();
