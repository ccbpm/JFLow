...
{
   var url1=webAppPath+"/Comm/"+'Item3.jsp?EnName='+className+url;
   var newWindow=window.open( url1,'card', 'width=700,top=50,left=50,height=500,scrollbars=yes,resizable=yes,toolbar=false,location=false' );
   newWindow.focus();
   return;
}
...
function HalperOfDDL (appPath, EnsName, refkeyvalue,  reftext, ddlID )
{
   ...
   if ( appPath=='/')
     url=  "DataHelp.htm?HelperOfDDL.jsp?EnsName="+EnsName+"&RefKey="+refkeyvalue+"&RefText="+reftext;
     else
...
{
     var url=''; 
     url=  "DataHelp.htm?HelperOfDDL.jsp?EnsName="+EnsName+"&RefKey="+refkeyvalue+"&RefText="+reftext+"&MainEns="+MainEns+"&DDLID="+ddlID;
