    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            initContextMenu: function () {
                // var _this = this
                // this.$nextTick(function () {
                //     var sortContainer = _this.classicalLayout ? _this.$refs['c-sort-tree'] : _this.$refs['sort-tree']
                //     for (let i = 0; i < sortContainer.length; i++) {
                //         new Sortable(sortContainer[i], {
                //             animation: 150,
                //             dataIdAttr: 'data-id',
                //             onEnd: function (evt) {
                //                 var arr = this.toArray();
                //                 _this.updateMenuSort(1, arr)
                //             }
                //         });
                //     }
                //
            ...
            // 更新目录排序
            updateMenuSort: function (pid, list) {

            },
            // 更新子排序
            updateSort: function (pid, list) {
