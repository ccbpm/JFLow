 ...
 * @constructor
 */
function OpenTopWindowTab(title,url){
    if(typeof window.top.vm!="undefined" && typeof window.top.vm.openTab=="function"){
    ...
    //下面是自定义
    //若依的实例
    //Skip.addJs("/ruoyi/js/common.js?v=4.7.4");
    // Skip.addJs("/ruoyi/js/ry-ui.js?v=4.7.4");
    // if(typeof $.modal!="undefined" && typeof $.modal.openTab=="function"){
