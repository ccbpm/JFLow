...
POP_Message.prototype.oncommand = function () {
    ...
    if (mesCount > 1) {
        ...
        $.ligerDialog.open({ height: 400, url: '../AppDemoLigerUI/SmsListDetail.aspx?MyPK=' + myPK, width: 450, showMax: true, showToggle: true, showMin: true, isResize: true, modal: false, title: '邮件详细信息' });
